...
<?php
include('db.php');
$result = $conn->prepare("SELECT * FROM teachers where teachers_id='$ID'");
$result->execute();
for($i=0; $row = $result->fetch(); $i++){
$id=$row['teachers_id'];
?>
<form class="form-horizontal" method="post" action="edit_PDO.php<?php echo '?teachers_id='.$id; ?>"  enctype="multipart/form-data" style="float: right;">
