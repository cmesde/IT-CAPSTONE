...
<body>
  <div class="container">
    <nav>
      <ul>
        <li><a href="teacher.php" class="logo">
        ...
        <li><a href="addstudentteacher.php">
          <i class="fas fa-tasks"></i>
          <span class="nav-item">Student</span>
        </a></li>
        <li><a href="/grading/login.php">
          <i class="fas fa-tasks"></i>
    ...
    <section class="main">
      ...
      <div class="main-skills">
        ...
        <img src="img/student.jpg" alt="">
          <h3><?=$_SESSION['name']?></h3>
          <p style="text-transform:capitalize; font-size: 18px;"><?=$_SESSION['role']?></p>
        </div>
